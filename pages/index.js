                  ...
                  <div className="grid grid-cols-4 gap-20 mx-20">
                    ...
                    >
                        ...
                        <div className="p-4 flex flex-col">
                          <p className="mb-4">For importing CSS required</p>
                          <p className="text-sm overflow-hidden"
                          >CSS Modules locally scope CSS by automatically creating a unique class name. This allows you to use the same CSS class name in differena.</p>
                        </div>
                    </motion.div>
                    <motion.div 
                      whileHover={
